			...
			<div class="flex flex-col xl:flex-row items-center gap-8 xl:gap-16">
				<div class="chairperson-image xl:basis-2/4">
					<img
						...
						:alt="chairperson.alt"
						class="rounded-2xl w-9/12 xl:w-11/12 mx-auto lg:max-h-[500px] max-h-[250px] h-[250px] lg:h-[500px] object-cover object-top" />
				</div>
...
<style lang="scss">
	@import '../../assets/scss/variables/_chairperson';
</style>
