  ...
  <header class="py-4 fixed text-white w-full z-10 transparent-shadow">
    <div class="container">
      <div class="block lg:flex items-center justify-between max-h-12">
        <div class="brand-wrap" v-for="item in brandWrap">
          <router-link to="/">
            <img :src="item.logoSrc" :alt="item.alt" class="w-36 lg:w-48" />
          </router-link>
          <!-- logo -->
          <div class="lg:hidden">
        ...
        <nav class="cb-nav max-h-144 overflow-scroll lg:overflow-visible" id="vl-nav">
          <ul class="block lg:flex" id="menu">
            <li class="cb-nav-item">
              <router-link to="/" class="cb-nav-link">Home</router-link>
            </li>
            <li class="cb-nav-item has-child">
              <a class="cb-nav-link">About </a>
              <ul class="cb-mega">
                <li class="mega-items hover:bg-indigo-50">
                  <a href="https://codebumble.net/web-app" class="mega-link">
                    <div class="flex items-center">
                      <div class="mr-3">
                        <i class="fas fa-terminal opacity-80 text-xl text-indigo-600"></i>
                      </div>
                      <div>
                    ...
                    <p class="my-3">
                      Create Your Own Website with low cost. Choose Your Website Type and
                      Stand Your Own.
                    </p>
                  </a>
                </li>
                ...
                <li class="mega-items hover:bg-green-50">
                  <a href="https://codebumble.net/video-production" class="mega-link">
                    <div class="flex items-center">
                      <div class="mr-3">
                        <i class="fas fa-video opacity-80 text-xl text-green-600"></i>
                      </div>
                      <div>
                    ...
                    <p class="my-3">
                      Make Your Own Promotional Video (Animation/2D/3D). Enhance the
                ...
                <li class="mega-items hover:bg-violet-50">
                  <a href="https://codebumble.net/uiux-service" class="mega-link">
                    <div class="flex items-center">
                      <div class="mr-3">
                        <i
                          class="fas fa-pencil-paintbrush opacity-80 text-xl text-violet-600"
                        ></i>
                      </div>
                      <div>
                    ...
                    <p class="my-3">
                      Design a product that is convenient to use, attractive, and
                      effective.
                    </p>
                  </a>
                </li>
                ...
                <li class="mega-items hover:bg-blue-50">
                  <a href="https://codebumble.net/seo-service" class="mega-link">
                    <div class="flex items-center">
                      <div class="mr-3">
                        <i class="fas fa-chart-line opacity-80 text-xl text-blue-600"></i>
                      </div>
                      <div>
                    ...
                    <p class="my-3">
                      Proper SEO means a website's content relevancy, link popularity,
                      using appropriate keywords, etc.
                    </p>
                  </a>
                </li>
              </ul>
            ...
            <li class="cb-nav-item">
              <router-link to="/career" class="cb-nav-link"> Career </router-link>
            </li>

            <li class="cb-nav-item">
              <router-link to="/photo-gallery" class="cb-nav-link"
                >Photo Gallery</router-link
              >
            </li>

            <li class="cb-nav-item">
              <router-link to="/etender" class="cb-nav-link">E-Tender</router-link>
            </li>
            <li class="cb-nav-item">
              <router-link to="/contact" class="cb-nav-link">Contact</router-link>
            </li>
          </ul>
          <!-- navigation items -->
        </nav>
  ...
  mounted() {
    ...
    const Menus = function (menu) {
      ...
      function toggleSubmenu(a) {
        const submenu = document.getElementById(a.getAttribute("aria-controls"));
      ...
      function setUpAria(submenu, a) {
        ...
        let id;
        if (null === submenuId) {
          id = a.textContent.trim().replace(/\s+/g, "-").toLowerCase() + "-submenu";
        } else {
