<template>
  <footer class="footer py-[30px]">
    <div class="container">
      ...
      >
        <div>
          <img :src="footerTop.logo" :alt="footerTop.alt" class="w-48" />
        </div>
        <div class="flex mt-[1.5rem]">
          <ul class="flex">
            <li class="mr-2 text-gray-600 hover:text-blue-600">
              <a :href="footerSocial.facebook" class=""
            ...
            <li class="mx-2 text-gray-600 hover:text-red-600">
              <a :href="footerSocial.youtube"><i class="fab fa-youtube text-3xl"></i></a>
            </li>
      ...
      <div class="flex flex-col lg:flex-row justify-between links">
        <div class="lg:oder-1 order-2 flex basis-8/12 flex-wrap text-sm">
        ...
        >
          <h2 class="text-4xl font-bold text-red-600 leading-snug mb-2">
            {{ footerAbout.heading }}
          </h2>
          <p class="">
      ...
      <div class="text-sm text-center lg:text-left">
        <p>
          &copy; 2022
          <router-link to="/" class="underline decoration-dotted decoration-gray-400"
            >Jamuna Group</router-link
          >
          all right reserved
        </p>
      </div>
