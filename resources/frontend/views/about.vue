<template>
	<section class="project-credit pb-28 pt-32">
		<div class="container">
			<div class="py-5 block lg:flex justify-between items-center">
				<h2 class="text-3xl lg:text-5xl font-bold">
					Our <span class="text-red-500">Mind Power</span>
				</h2>
			</div>
			<div class="team grid grid-cols-1 lg:grid-cols-4 gap-3">
				<div class="item">
					<div class="item-body">
						<img
									...
									<a
										...
										<svg
											...
											<circle
												...
												r="4"></circle>
											<path
												d="M16 8v5a3 3 0 0 0 6 0v-1a10 10 0 1 0-3.92 7.94"></path></svg
									></a>
								</li>
							</ul>
						</div>
