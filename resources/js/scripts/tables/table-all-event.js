 ...
 $(function () {
	...
	if (dt_basic_table.length) {
	  var dt_basic = dt_basic_table.DataTable({
		ajax: assetPath + 'codebumble/event/all-event',
		columns: [
		  { data: 'id' },
		  { data: 'id' },
...

		  {
			...
			render: function (data, type, full, meta) {
			  return (
				...
				'<a href="/admin/event/edit-event/'+full['id']+'" class="dropdown-item">' +
				feather.icons['archive'].toSvg({ class: 'font-small-4 me-50' }) +
				'Edit</a>' +
				'<a href="/codebumble/event/delete-event/'+full['id']+'" class="dropdown-item delete-record">' +
				feather.icons['trash-2'].toSvg({ class: 'font-small-4 me-50' }) +
				'Delete</a>' +
				'</div>' +
				'</div>' +
				'<a href="/admin/event/edit-event/'+full['id']+'" class="item-edit">' +
