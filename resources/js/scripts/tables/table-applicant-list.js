 ...
 */
 ...
 $(function () {
	...
	if (dt_basic_table.length) {
		...
		columnDefs: [
		  ...
		  },
		  {
			...
			render: function (data, type, full, meta) {
			  ...
			  var $status = {
				1: { title: 'Applied', class: 'badge-light-primary' },
				2: { title: 'Applied', class: ' badge-light-success' },
				3: { title: 'Applied', class: ' badge-light-danger' },
				4: { title: 'Applies', class: ' badge-light-warning' },
	  ...
	  $('div.head-label').html('<h6 class="mb-0">Report Of Office Staff</h6>');
	}
