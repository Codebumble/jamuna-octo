...
<section id="ecommerce-products" class="grid-view">
  @foreach ($data as $d)
    ...
    <div class="item-img text-center d-block">
      <a href="#">
        <img
          class="img-fluid card-img-top" style="height: 18rem; object-fit: cover; max-width: 100%;margin: auto;"
          src="{{$d->image}}"
          alt="img-placeholder"
      /></a>
    </div>
    <div class="card-body">
      ...
      <h6 class="item-name">
        ...
        <span class="card-text item-company">By <a href="#" class="company-name">{{$d->company}}</a></span>
      </h6>
