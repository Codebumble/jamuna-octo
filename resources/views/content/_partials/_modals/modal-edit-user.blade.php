      ...
      <div class="modal-body pb-5 px-sm-5 pt-50">
        ...
        <form id="editUserForm" class="row gy-1 pt-75" onsubmit="return false">
          ...
          <div class="col-12 col-md-6">
            ...
            >
              <option value="{{json_decode($auther['json_data'])->gender}}" selected>{{json_decode($auther['json_data'])->gender}}</option>
          ...
          <div class="col-12 col-md-6">
            <label class="form-label" for="modalEditUserLanguage">Address</label>
            <input
              type="text"
