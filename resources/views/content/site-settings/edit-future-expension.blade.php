...
@section('title', 'Edit This Future Expension Content')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Edit This Future Expension Content</h4>
        </div>
        <div class="card-body">
        ...
        @endif
          ...
          <form class="needs-validation" novalidate action="{{route('future_expension_component_edit', ['id' => $data->id])}}" enctype="multipart/form-data" id="job-post" method="POST">
		  @csrf
				<div class="row">
