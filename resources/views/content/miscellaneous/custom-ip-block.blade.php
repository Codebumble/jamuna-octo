...
<html lang="en">
  <head>
    ...
    <title>Access Restricted - {{env("APP_NAME")}}</title>
...
ul{
  ...
  <div id="container">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1278 1080">
      ...
      <div id="details">
        <ul>
          <li><span>Your IP:</span><span>{{$ip}}</span></li>
          <li><span>Method:</span><span>Restricted 1hour</span></li>
          <li><span>Reason</span><span>Unsual Activites</span></li>
        </ul>
