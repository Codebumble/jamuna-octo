...
// Main Page Route
Route::get('{any}', [FrontendController::class, 'home'])->where('any', '/|founder|board-of-directors|company-profile|jamuna-tv|the-daily-jugantor|hoorain-htf|hoor|hooram|growth-story|jamuna-denims-garments-ltd|jeansco|quality-process|future-expansion|contact|photo-gallery|career|');
