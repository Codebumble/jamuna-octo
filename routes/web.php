...
// Main Page Route
Route::get('{any}', [FrontendController::class, 'home'])->where('any', '/|founder|board-of-directors|company-profile|news-center|hoorain-htf|hoor|hooram|growth-history|jamuna-denims-garments-ltd|jeansco|');
